...
from rki_tools import for_region, for_age_bracket, for_timespan, for_week, count_array, AGE_BRACKETS, REGIONS,RelativeCounter
import matplotlib.pyplot as plt
import matplotlib.dates as mdates


data = load_rki_csv("./rki.csv")
week = datetime.date(2020, 12, 7)
...
for region_name in REGIONS:
    ...
    rc = RelativeCounter(count_array(all_for_region,lambda x: x.age_bracket ))
    print(rc)
